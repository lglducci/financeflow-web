...
export default function AppFluxoCaixaRealizado() {
  ...
  async function consultar(qtd = dias) {
    try {
      ...
      const resp = await fetch(buildWebhookUrl("gera_fluxo_caixa_grafico_diario"), {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          empresa_id,
          data_ini: dataMenosDias(qtd),
          data_fim: hojeLocal(),
        }),
      });
